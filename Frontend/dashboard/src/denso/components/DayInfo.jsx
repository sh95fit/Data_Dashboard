...
const DayInfo = () => {
  ...
  const { facilityCapacity, tempval, tempmin, sky, loading, error } = useSelector((state) => state.dayinfo_denso, shallowEqual);
    ...
    <div className='w-full h-full bg-white'>
      <div className="w-full h-[60%] -mb-[25px]">
        <div className='flex justify-between w-full h-full p-8'>
          ...
          <div className='relative flex items-center justify-between flex-1 w-1/3'>
            <div className='ml-6 text-6xl font-bold'>
              <span>{tempval}°</span>
              {/* <span>27°</span> */}
            </div>

...
const RealtimeDate = () => {
  ...
  const currentDate = useSelector((state) => state.dayinfo_tk.currentDate);
  // const currentDay = useSelector((state) => state.dayinfo_tk.currentDay);
  const currentTime = useSelector((state) => state.dayinfo_tk.currentTime);
  ...
  return (
    <div className='flex justify-around items-center text-5xl font-extrabold gap-5'>
      <div>
        {currentDate}
      </div>
